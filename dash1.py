...
icon = Image.open(r"C:\Users\User\Downloads\PhonePe_Logo.jpg")
st.set_page_config(page_title="Phonepe Pulse Data Visualization | By NIVETHA",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This dashboard app is created by *NIVETHA*!
...
if selected == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_excel(r"C:\Users\User\Downloads\indiastates.xlsx")
            df1.State = df2
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/nivethaeswaran/Phonepe-Pulse-Data-Visualization-and-Exploration-A-User-Friendly-Tool-Using-Streamlit-and-Plotly.git")
